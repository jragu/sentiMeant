...
def parse_tone(tone):
    ...
    emoji=find_emoji(find_max_emotion(eVals, eTones), find_max_language(lVals, lTones))
...
def find_emoji(mainEmotionValue, mainLanguageValue):
    ...
    if mainEmotionValue=='disgust' || mainLanguageValue=='analytical':
       return(aDisgust)
    elif (mainEmotionValue=='disgust') || (mainLanguageValue=='confident'):
        return(cDisgust)
    elif (mainEmotionValue=='disgust') || (mainLanguageValue=='tentative'):
        return(tDisgust)
    elif mainEmotionValue=='fear' || mainLanguageValue=='analytical':
       return(aFear)
    elif (mainEmotionValue=='fear') || (mainLanguageValue=='confident'):
        return(cFear)
    elif (mainEmotionValue=='fear') || (mainLanguageValue=='tentative'):
        return(tFear)
    elif mainEmotionValue=='joy' || mainLanguageValue=='analytical':
       return(aJoy)
    elif (mainEmotionValue=='joy') || (mainLanguageValue=='confident'):
        return(cJoy)
    elif (mainEmotionValue=='joy') || (mainLanguageValue=='tentative'):
        return(tJoy)
    elif mainEmotionValue=='sadness' || mainLanguageValue=='analytical':
       return(aSadness)
    elif (mainEmotionValue=='sadness') || (mainLanguageValue=='confident'):
        return(cSadness)
    elif (mainEmotionValue=='sadness') || (mainLanguageValue=='tentative'):
        return(tSadness)
    elif mainEmotionValue=='Anger' || mainLanguageValue=='analytical':
       return(aAnger)
    elif (mainEmotionValue=='Anger') || (mainLanguageValue=='confident'):
        return(cAnger)
    elif (mainEmotionValue=='Anger') || (mainLanguageValue=='tentative'):
        return(tAnger)
